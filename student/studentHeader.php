    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="generatereport.php" class="active"><span class="las la-clipboard-list"></span>
    ...
    <div class="main-content">
        <header>
            ...
            <div class="user-wrapper">
                <div>
                    <h4><?php echo $_SESSION['first_name'].' '.$_SESSION['middle_name'].' '.$_SESSION['last_name']?></h4>
                    <small>
